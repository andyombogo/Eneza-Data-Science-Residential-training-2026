"""Task 1 demo app: interactive maternal risk predictor + model report.
...
st.set_page_config(
    page_title="Maternal Risk Predictor — Project 7",
    page_icon="🩺",
    layout="wide",
)
...
st.caption(
    "Project 7 — Maternal & Child Health Outcomes · Task 1 · "
    "[GitHub repo](https://github.com/andyombogo/Eneza-Data-Science-Residential-training-2026/tree/project7-setup/project7-maternal-child-health)"
)
...
- **Data protection.** This dataset is de-identified and public; any future
  ...
  the Kenya Data Protection Act, 2019.
    ...
    st.markdown(
        """
Part of **Project 7 — Maternal & Child Health Outcomes**,
Eneza Data Science Residential Training 2026.

- **Task 1** (this app): John Andrew, Jared Onsomu
- **Task 2** (regional/wealth EDA): Kevinson Mwangi, Elphas Abok
- **Task 3** (fairness & calibration audit): TBD
- **Task 4** (intervention targeting): TBD

Full source, notebook, and README: see the project's GitHub repository.
        """
    )
